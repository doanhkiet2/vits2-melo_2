...
TRAIN_IN = Path("/content/vits2-melo/xuly/train2.list")
TRAIN_OUT = Path("/content/vits2-melo/xuly/train3.list")
REMOVED_OUT = Path("/content/vits2-melo/xuly/train.removed_bad_source.list")
